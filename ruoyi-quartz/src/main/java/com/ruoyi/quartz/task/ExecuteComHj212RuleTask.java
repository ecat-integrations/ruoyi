...
@Component("ExecuteComHj212RuleTask")
public class ExecuteComHj212RuleTask {
    @Autowired
    ...
    private static final Logger log = LoggerFactory.getLogger(ExecuteComHj212RuleTask.class);
    ...
    public void run(String triggerType, String host, String port, String ruleId, String start, String end, Boolean istime) throws ParseException {
        ...
        IIntegrationTaskManagement executeHj212RuleTask = (IIntegrationTaskManagement) core.getIntegrationRegistry()
                .getIntegration("integration-com-hj212-sender");
        Task wantedTask = executeHj212RuleTask.getTaskExecutor().getTask("hj212SenderTask");
